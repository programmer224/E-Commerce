                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('category.edit',$banner->id)}}" data-toggle="tooltip" title="edit" data-placement="bottom" class="float-left btn btn-sm btn-outline-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>


                                            <form class="float-left" action="{{route('category.destroy',$banner->id)}}" method="post">
