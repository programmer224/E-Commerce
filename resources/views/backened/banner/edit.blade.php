                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Title" value="{{$banner->title}}" name="title">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Description" name="description"> {{$banner->description}} </textarea>
                                </div>
                            </div>
                        </div>
